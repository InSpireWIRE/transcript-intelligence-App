...
<style>
    ...
    /* === TRANSCRIPT SELECTOR - NEW EXPANDER UI === */
    .transcript-selector {
        background-color: #1A1A1A;
        border: 2px solid #00bcd4;
        border-radius: 8px;
